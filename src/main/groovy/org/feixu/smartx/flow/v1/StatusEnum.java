...
public enum StatusEnum {
    /** 开始 */
    START("START", "开始", new String[]{OperationTypeEnum.SUBMIT.getCode(), OperationTypeEnum.EDIT.getCode()}),
    DRAFT("DRAFT", "草稿", new String[]{OperationTypeEnum.SUBMIT.getCode(), OperationTypeEnum.EDIT.getCode(), OperationTypeEnum.DELETE.getCode()}),
